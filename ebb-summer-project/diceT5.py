...
def determine_scores(player_roll, computer_roll, draws):
    ...
    if player_roll > computer_roll:
        ...
        number_of_draws += 1
    return player_score, computer_score, number_of_draws
...
def play_game(player_name):
    ...
    for rounds in range(1, number_of_rounds+1):
        ...
        guess = guess_roll()
        draws = 0
        player_score, computer_score, number_of_draws = determine_scores(player_roll, computer_roll, draws )
        ...
        if player_roll > computer_roll:
            ...
            new_number_of_draws += number_of_draws
            print("It is a draw")
        ...
        elif player_score > computer_score and rounds % 2 == 0:
            print("Your Guess is incorrect and but you Still Earned 2 Bonus Points as your score is higher than the computer and the roll is even. ")
            bonus_points += 2
            new_player_score = player_score + 2
        else:
        ...
        print(f"Draws: {new_number_of_draws}") 
